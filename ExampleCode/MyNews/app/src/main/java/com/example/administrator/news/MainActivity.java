...
public class MainActivity extends AppCompatActivity {
    ...
    private static String rssUrl = "http://news.sbs.co.kr/news/SectionRssFeed.do?sectionId=14";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText = (EditText) findViewById(R.id.rssUrl);
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String inputUrl = editText.getText().toString().trim();
                showRSS(inputUrl);
            }
        });
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                NewsItem curItem = (NewsItem) adapter.getItem(position);
                String curTitle = curItem.getTitle();
                Log.e("setOnItemClickListener", curTitle);
    ...
    class RefreshThread extends Thread {
        ...
        public void run() {
            try {
                ...
                Log.d("RefreshThread", countItem + " news item processed.");
    ...
    public InputStream getInputStreamUsingHTTP(URL url) throws Exception {
        ...
        Log.d("InputStream", "Response Code : " + resCode);
    ...
    private int processDocument(Document doc) {
        ...
        if ((nodelist != null) && (nodelist.getLength() > 0)) {
            for (int i = 0; i < nodelist.getLength(); i++) {
                NewsItem newsItem = dissectNode(nodelist, i);
                if (newsItem != null) {
    ...
    private NewsItem dissectNode(NodeList nodelist, int index) {
        ...
        try {
            ...
            Log.d("dissectNode", "item node : " + titleValue + ", " + linkValue + ", " + descriptionValue +
                    ", " + pubDateValue + ", " + authorValue + ", " + categoryValue);

            newsItem = new NewsItem(titleValue, linkValue, descriptionValue,
                    pubDateValue, authorValue, categoryValue);
        ...
        public void run() {
            ...
            try {
                ...
                for (int i = 0; i < newsItemList.size(); i++) {
                    NewsItem newsItem = (NewsItem) newsItemList.get(i);
